...
var formAGroupDialog = React.createClass({
  propTypes: {
  ...
  render: function(){
    return (
      React.createElement(MaterialUI.Dialog, {open: this.state.open, title: 'Create a Study Group', actions: [
...
module.exports = formAGroupDialog;